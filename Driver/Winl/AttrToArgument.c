...
static BOOLEAN _AttrType_To_ArgType_Datapath(OVS_ARGTYPE parentArgType, UINT16 attrType, OVS_ARGTYPE* pTypeAsArg)
{
    *pTypeAsArg = OVS_ARGTYPE_GROUP_MAIN;
	...
	case OVS_USPACE_DP_ATTRIBUTE_MEGAFLOW_STATS:
		*pTypeAsArg = OVS_ARGTYPE_DATAPATH_MEGAFLOW_STATS;
		DEBUGP_ARG(LOG_INFO, "rcv arg: OVS_ARGTYPE_DATAPATH_MEGAFLOW_STATS\n");
		return TRUE;

	case OVS_USPACE_DP_ATTRIBUTE_USER_FEATURES:
		*pTypeAsArg = OVS_ARGTYPE_DATAPATH_USER_FEATURES;
		DEBUGP_ARG(LOG_INFO, "rcv arg: OVS_ARGTYPE_DATAPATH_USER_FEATURES\n");
		return TRUE;
...
static BOOLEAN _AttrType_To_ArgType_PacketInfo(UINT16 attrType, OVS_ARGTYPE* pTypeAsArg)
{
    ...
    case OVS_USPACE_KEY_ATTRIBUTE_TUNNEL:
        *pTypeAsArg = OVS_ARGTYPE_GROUP_PI_TUNNEL;
		...
		//NOT NESTED
	case OVS_USPACE_KEY_ATTRIBUTE_DP_HASH:
		*pTypeAsArg = OVS_ARGTYPE_PI_DATAPATH_HASH;

		DEBUGP_ARG(LOG_INFO, "rcv arg: OVS_ARGTYPE_PI_DATAPATH_HASH\n");
		return TRUE;

	case OVS_USPACE_KEY_ATTRIBUTE_RECIRC_ID:
		*pTypeAsArg = OVS_ARGTYPE_PI_DATAPATH_RECIRCULATION_ID;

		DEBUGP_ARG(LOG_INFO, "rcv arg: OVS_ARGTYPE_PI_DATAPATH_RECIRCULATION_ID\n");
		return TRUE;
	...
	case OVS_USPACE_KEY_ATTRIBUTE_TCP_FLAGS:
		*pTypeAsArg = OVS_ARGTYPE_PI_TCP_FLAGS;

		DEBUGP_ARG(LOG_INFO, "rcv arg: OVS_ARGTYPE_FLOW_KEY_TCP_FLAGS\n");
		return TRUE;
	...
	case OVS_USPACE_KEY_ATTRIBUTE_SCTP:
		*pTypeAsArg = OVS_ARGTYPE_PI_SCTP;

		DEBUGP_ARG(LOG_INFO, "rcv arg: OVS_ARGTYPE_FLOW_KEY_SCTP\n");
		return TRUE;

	case OVS_USPACE_KEY_ATTRIBUTE_MPLS:
		*pTypeAsArg = OVS_ARGTYPE_PI_MPLS;

		DEBUGP_ARG(LOG_INFO, "rcv arg: OVS_ARGTYPE_PI_MPLS\n");
		return TRUE;
...
static BOOLEAN _AttrType_To_ArgType_FlowKeyTunnel(UINT16 attrType, OVS_ARGTYPE* pTypeAsArg)
{
	...
	case OVS_USPACE_TUNNEL_KEY_ATTRIBUTE_OAM:
		*pTypeAsArg = OVS_ARGTYPE_PI_TUNNEL_OAM;

		DEBUGP_ARG(LOG_INFO, "rcv arg: OVS_ARGTYPE_PI_TUNNEL_OAM\n");
		return TRUE;

	case OVS_USPACE_TUNNEL_KEY_ATTRIBUTE_GENEVE_OPTIONS:
		*pTypeAsArg = OVS_ARGTYPE_PI_TUNNEL_GENEVE_OPTIONS;

		DEBUGP_ARG(LOG_INFO, "rcv arg: OVS_ARGTYPE_PI_TUNNEL_GENEVE_OPTIONS\n");
		return TRUE;
...
static BOOLEAN _AttrType_To_ArgType_Actions(UINT16 attrType, OVS_ARGTYPE* pTypeAsArg)
{
	...
	case OVS_USPACE_ACTION_ATTRIBUTE_PUSH_MPLS:
		*pTypeAsArg = OVS_ARGTYPE_ACTION_PUSH_MPLS;
		DEBUGP_ARG(LOG_INFO, "rcv arg: OVS_ARGTYPE_ACTION_PUSH_MPLS\n");
		return TRUE;

	case OVS_USPACE_ACTION_ATTRIBUTE_POP_MPLS:
		*pTypeAsArg = OVS_ARGTYPE_ACTION_POP_MPLS;
		DEBUGP_ARG(LOG_INFO, "rcv arg: OVS_ARGTYPE_ACTION_POP_MPLS\n");
		return TRUE;
	...
	case OVS_USPACE_ACTION_ATTRIBUTE_RECIRC:
		*pTypeAsArg = OVS_ARGTYPE_ACTION_RECIRCULATION;
		DEBUGP_ARG(LOG_INFO, "rcv arg: OVS_ARGTYPE_ACTION_RECIRCULATION\n");
		return TRUE;

	case OVS_USPACE_ACTION_ATTRIBUTE_HASH:
		*pTypeAsArg = OVS_ARGTYPE_ACTION_HASH;
		DEBUGP_ARG(LOG_INFO, "rcv arg: OVS_ARGTYPE_ACTION_HASH\n");
		return TRUE;
